...
namespace SST {
    ...
    namespace Hermes {
        ...
        public:
            typedef enum {
                Empty, Double, Float, Int, Long, LongDouble, LongLong, Short
            } Type;
            ...
            Value(long double v) : m_type(LongDouble), m_length(sizeof(long double)),
                                   m_value(sizeof(long double)) {
                m_ptr = &m_value[0];
                set(v);
            }
            ...
            Value(long long v) : m_type(LongLong), m_length(sizeof(long long)),
                                 m_value(sizeof(long long)) {
                m_ptr = &m_value[0];
                set(v);
            }
            ...
            Value(long double *ptr) : m_type(LongDouble), m_length(sizeof(long double)),
                                      m_ptr(ptr) {}
